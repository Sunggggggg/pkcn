...
dataset_dict = {'h36m': H36M, 'mpii': MPII, 'coco': COCO14, 'pw3d':PW3D, 'crowdpose':Crowdpose,\
 'lsp':LSP, 'mpiinf':MPI_INF_3DHP, 'cmup':CMU_Panoptic_eval,'internet':Internet, 'muco':MuCo, 'hi4d': Hi4D }

class MixedDataset(torch.utils.data.Dataset):
    def __init__(self, **kwargs):
        datasets_used = args().dataset.split(',')
        print("Mixed dataset :", datasets_used)
