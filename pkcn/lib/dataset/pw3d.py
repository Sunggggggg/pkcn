...
class PW3D(Image_base):
    def __init__(self,train_flag = False, split='train', mode='vibe', regress_smpl=False, **kwargs):
        #if train_flag:
    ...
    def get_image_info(self, index):
        ...
        for inds, annot in enumerate(annots):
            ...
            params.append(np.concatenate([pose_param[:], beta_param[:10]]))
